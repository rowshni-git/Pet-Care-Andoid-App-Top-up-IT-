package bracu.topup.petcareapp.AccountActivity_firebase;
...
public class SignUp_Activity extends AppCompatActivity{
                ...
                auth.createUserWithEmailAndPassword(email, password)
                        .addOnCompleteListener(SignUp_Activity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                Toast.makeText(SignUp_Activity.this, "created User" + task.isSuccessful(), Toast.LENGTH_SHORT).show();
    ...
    public void btnLoginSignIN (View view){
        startActivity(new Intent(SignUp_Activity.this, Login_Activity.class));
        finish();
    }
